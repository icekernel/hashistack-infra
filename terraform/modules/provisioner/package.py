...
# NOTICE: taken from https://github.com/terraform-aws-modules/terraform-aws-lambda/blob/eebfc36/package.py

import sys

if sys.version_info < (3, 8):
    raise RuntimeError("A python version 3.8 or newer is required")
...
def install_pip_requirements(query, requirements_file, tmp_dir):
    ...
    with tempdir(tmp_dir) as temp_dir:
        ...
        print("directory_content: ", os.listdir(temp_dir))
